...
const newNormativasData = `export const NORMATIVAS: Normativa[] = [
  {
    id: 'dama-dmbok2',
    codigo: 'DAMA-DMBOK-2',
  ...
  },
  {
    ...
    riesgos: [
      { id: 'r1', nombre: 'Falta de interoperabilidad entre sistemas gubernamentales', impacto: 'Alto', probability: 'Alta', tratamiento: 'Adopción de estándares de interoperabilidad del MinTIC' },
    ],
  ...
  },
  {
    ...
    description: 'Estándar ISO para el gobierno de los datos por parte de las organizaciones. Define principios, modelos y prácticas para el gobierno responsable del uso de datos.',
...
// Read the current file, find where NORMATIVAS starts and where it ends
let content = fs.readFileSync(filePath, 'utf8');
const startIndex = content.indexOf('export const NORMATIVAS: Normativa[]');
const endIndex = content.indexOf('export const AI_RESPONSES: Record<string, string[]>');

if (startIndex !== -1 && endIndex !== -1) {
  const newContent = content.substring(0, startIndex) + newNormativasData + '\n\n' + content.substring(endIndex);
  fs.writeFileSync(filePath, newContent, 'utf8');
  console.log('Successfully enriched NORMATIVAS compliance and checklist details with professional standards!');
} else {
  console.error('Could not find start or end index for NORMATIVAS in file.');
}
