...
export const NORMATIVAS: Normativa[] = [
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Existe un programa formal de Gobierno de Datos con patrocinio ejecutivo?', dominio: 'Data Governance', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se ha definido un CDO o rol equivalente en la organización?', dominio: 'Data Governance', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Existe un inventario o catálogo de activos de datos empresarial?', dominio: 'Data Architecture', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se han definido y documentado dimensiones de calidad de datos?', dominio: 'Data Quality', estado: 'parcial' },
      { id: 'ch5', pregunta: '¿Existe un repositorio de metadatos de negocio y técnicos?', dominio: 'Metadata', estado: 'cumple' },
      { id: 'ch6', pregunta: '¿Se realizan evaluaciones periódicas de madurez en gestión de datos (DAMA/DCAM)?', dominio: 'Data Governance', estado: 'cumple' },
      { id: 'ch7', pregunta: '¿Los Data Stewards y Data Owners tienen responsabilidades formalmente documentadas y asignadas?', dominio: 'Data Governance', estado: 'parcial' },
      { id: 'ch8', pregunta: '¿Existen políticas corporativas de clasificación, retención y ciclo de vida de datos?', dominio: 'Data Architecture', estado: 'cumple' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Se han definido dimensiones de calidad de datos para datos críticos de negocio (CDE)?', dominio: 'Data Quality', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Existen umbrales mínimos de calidad y KPIs documentados por entidad?', dominio: 'Data Quality', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Se realizan análisis de perfilamiento de calidad de datos periódicamente?', dominio: 'Data Quality', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿El linaje y origen de datos (Data Provenance) está documentado para reportes clave?', dominio: 'Metadata', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Existen procesos automáticos de detección y alertas para errores de calidad?', dominio: 'Data Quality', estado: 'no_cumple' },
    ],
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Existe una política de seguridad de la información formalmente aprobada por la dirección?', dominio: 'Organizational', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se ha realizado un análisis de riesgos de seguridad que cubra todos los activos críticos en el último año?', dominio: 'Risk Management', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Existe un programa activo de concienciación en seguridad de la información para empleados?', dominio: 'People', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se gestiona y mantiene actualizado un inventario de activos de información con su respectiva clasificación?', dominio: 'Organizational', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Existe un procedimiento documentado y probado para la gestión y escalación de incidentes de seguridad?', dominio: 'Technological', estado: 'parcial' },
      { id: 'ch6', pregunta: '¿Se realizan auditorías internas periódicas para evaluar la conformidad con el estándar?', dominio: 'Audit', estado: 'cumple' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Existe un Registro de Actividades de Tratamiento (RAT/ROPA) actualizado por área?', dominio: 'Accountability', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se ha definido y documentado una base legal válida para cada tratamiento de datos?', dominio: 'Lawfulness', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Están habilitados canales y workflows para resolver el derecho al olvido y portabilidad en menos de 30 días?', dominio: 'Rights', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se realizan evaluaciones de impacto (DPIA) antes de implementar nuevos sistemas de datos?', dominio: 'Risk Management', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Los contratos con terceros encargados (Data Processors) incluyen cláusulas del Art. 28?', dominio: 'Contracts', estado: 'cumple' },
      { id: 'ch6', pregunta: '¿Existe un proceso para detectar y notificar brechas de seguridad a la autoridad en menos de 72 horas?', dominio: 'Security', estado: 'no_cumple' },
    ],
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Están inscritas y actualizadas anualmente las bases de datos en el RNBD de la SIC?', dominio: 'Legal', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Está la Política de Tratamiento de Datos Personales (PTDP) aprobada, publicada y accesible a los titulares?', dominio: 'Governance', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Se obtienen autorizaciones previas, expresas e informadas de forma trazable para cada finalidad de tratamiento?', dominio: 'Consent', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Existe un Oficial de Protección de Datos formalmente nombrado en la organización?', dominio: 'Governance', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Se cuenta con contratos de transmisión de datos (con cláusulas del Decreto 1377) para proveedores terceros?', dominio: 'Contracts', estado: 'parcial' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Está el Botón de Transparencia y Acceso a la Información implementado y visible en el sitio web principal?', dominio: 'Transparency', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se han publicado el Registro de Activos de Información, el Índice de Información Clasificada y Reservada, y el Esquema de Publicación?', dominio: 'Transparency', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Existen canales y un flujo documentado para la atención de solicitudes de información pública?', dominio: 'Citizen Rights', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se publica la información de compras y contratación de forma proactiva y estructurada (SECOP)?', dominio: 'Transparency', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Se cuenta con un Programa de Gestión Documental (PGD) alineado a las directrices del Archivo General de la Nación?', dominio: 'Records Management', estado: 'no_cumple' },
    ],
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Se cuenta con un inventario de activos de datos priorizado para interoperabilidad y datos abiertos?', dominio: 'Data Strategy', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se han adoptado y habilitado los lineamientos de servicios de interoperabilidad del MinTIC (intercambio seguro)?', dominio: 'Interoperability', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Se ha capacitado al personal del área de analítica y datos en las metodologías oficiales de Big Data del gobierno?', dominio: 'Talent', estado: 'parcial' },
      { id: 'ch4', pregunta: '¿La entidad cuenta con una arquitectura de datos alineada con el Marco de Referencia de Arquitectura Empresarial (MRAE)?', dominio: 'Architecture', estado: 'no_cumple' },
      { id: 'ch5', pregunta: '¿Se aplican técnicas de analítica de datos en el diseño y evaluación de los trámites y servicios de la entidad?', dominio: 'Decision Making', estado: 'cumple' },
    ],
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Se han definido las políticas de ciberseguridad y están alineadas con la estrategia corporativa (función GOVERN)?', dominio: 'Govern', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se mantiene un inventario de activos físicos y de software y se evalúan sus riesgos (función IDENTIFY)?', dominio: 'Identify', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Existen controles de seguridad técnicos como cifrado de datos y MFA para accesos sensibles (función PROTECT)?', dominio: 'Protect', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se realiza monitoreo continuo de seguridad y detección de anomalías en redes y sistemas (función DETECT)?', dominio: 'Detect', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Se cuenta con un plan de respuesta a incidentes de ciberseguridad documentado y probado (función RESPOND)?', dominio: 'Respond', estado: 'parcial' },
      { id: 'ch6', pregunta: '¿Se tienen planes de recuperación y resiliencia para restaurar las operaciones críticas (función RECOVER)?', dominio: 'Recover', estado: 'no_cumple' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Existe un modelo de gobierno de TI implementado con responsabilidades claras para el órgano directivo (EDM01)?', dominio: 'EDM - Evaluate, Direct, Monitor', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se cuenta con una estrategia de TI definida y comunicada a las unidades de negocio (APO02)?', dominio: 'APO - Align, Plan, Organize', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Está establecido un proceso de gestión de riesgos de TI alineado con el marco de riesgo corporativo (APO12)?', dominio: 'APO - Align, Plan, Organize', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se gestionan y evalúan los acuerdos de nivel de servicio (SLA) con proveedores y clientes internos (DSS01)?', dominio: 'DSS - Deliver, Service, Support', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Se evalúa la conformidad de los procesos de TI con los requisitos regulatorios y de políticas (MEA03)?', dominio: 'MEA - Monitor, Evaluate, Assess', estado: 'cumple' },
      { id: 'ch6', pregunta: '¿Se gestionan formalmente los activos de datos y la calidad de la información empresarial (APO14)?', dominio: 'APO - Align, Plan, Organize', estado: 'no_cumple' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Están formalmente asignadas las responsabilidades para la creación y uso de datos (Principio de RESPONSABILIDAD)?', dominio: 'Responsibility', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿La estrategia de datos está alineada y documentada con la estrategia de negocio (Principio de ESTRATEGIA)?', dominio: 'Strategy', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Se cuenta con políticas para asegurar la adquisición ética y legal de datos externos (Principio de ADQUISICIÓN)?', dominio: 'Acquisition', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Los sistemas de datos están optimizados para apoyar el desempeño comercial (Principio de DESEMPEÑO)?', dominio: 'Performance', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Se audita de forma periódica que el uso de datos cumple con las regulaciones aplicables (Principio de CONFORMIDAD)?', dominio: 'Conformance', estado: 'no_cumple' },
      { id: 'ch6', pregunta: '¿Se capacita a la organización para que la cultura y las competencias soporten el uso responsable (Principio de COMPORTAMIENTO)?', dominio: 'Human Behaviour', estado: 'cumple' },
    ],
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Se utiliza el método ADM de TOGAF para guiar los proyectos de transformación y cambios de sistemas?', dominio: 'Architecture Development Method', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Se mantiene un repositorio centralizado de arquitectura empresarial (Architecture Repository) con modelos vigentes?', dominio: 'Architecture Repository', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Existe una Junta de Gobierno de Arquitectura (Architecture Board) que evalúe y apruebe las desviaciones?', dominio: 'Governance', estado: 'parcial' },
      { id: 'ch4', pregunta: '¿Se han definido e implementado formalmente los principios de arquitectura de datos empresariales?', dominio: 'Data Architecture', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Están documentados los diagramas de arquitectura de datos actuales (As-Is) y de destino (To-Be) para los dominios clave?', dominio: 'Architecture Content', estado: 'no_cumple' },
    ],
    versiones: [
  ...
  },
  {
    ...
    checklist: [
      { id: 'ch1', pregunta: '¿Se ha realizado una evaluación formal y documentada de madurez usando los 8 componentes de DCAM 2.0?', dominio: 'Assessment', estado: 'cumple' },
      { id: 'ch2', pregunta: '¿Existe un plan de negocio de datos (Data Business Case) alineado a la estrategia corporativa?', dominio: 'Data Strategy', estado: 'cumple' },
      { id: 'ch3', pregunta: '¿Están identificados los Elementos de Datos Críticos (CDE) requeridos por el negocio y los reguladores?', dominio: 'Data Architecture', estado: 'cumple' },
      { id: 'ch4', pregunta: '¿Se cuenta con un modelo organizativo formalizado de Stewardship de Datos?', dominio: 'Organization', estado: 'cumple' },
      { id: 'ch5', pregunta: '¿Existen políticas y métricas de calidad de datos asociadas a los CDEs identificados?', dominio: 'Data Quality', estado: 'cumple' },
      { id: 'ch6', pregunta: '¿Se realiza control de versionamiento e inventario de datos maestros y de referencia (MDM)?', dominio: 'Lifecycle', estado: 'cumple' },
      { id: 'ch7', pregunta: '¿Se audita y valida que la infraestructura y herramientas apoyen la estrategia de datos de forma segura?', dominio: 'Technology', estado: 'no_cumple' },
      { id: 'ch8', pregunta: '¿Se cuenta con un roadmap formal de remediación para las brechas de capacidad identificadas?', dominio: 'Assessment', estado: 'no_cumple' },
    ],
    versiones: [
