    ...
    activities: [
      {
        ...
        expectedResult: 'Haber completado y guardado al menos 1 evaluación de madurez DAMA en el módulo.',
        moduleHref: '/maturity',
      ...
      },
      {
        ...
        expectedResult: 'Tener al menos 3 hallazgos registrados en la base de datos.',
        moduleHref: '/maturity',
      ...
      },
      {
        ...
        expectedResult: 'Configurar al menos 3 hitos o fases planificadas en tu Roadmap.',
        moduleHref: '/maturity',
